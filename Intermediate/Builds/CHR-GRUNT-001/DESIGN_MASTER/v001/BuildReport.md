...
**Generated at (UTC):** `2026-08-06T18:01:26.270980+00:00`  
**Authorization:** **TEST BUILD — NOT PRODUCTION AUTHORIZED**

## Outputs

- Prompt: `Intermediate/Builds/CHR-GRUNT-001/DESIGN_MASTER/v001/Prompt.md`
- Manifest: `Intermediate/Builds/CHR-GRUNT-001/DESIGN_MASTER/v001/GenerationManifest.yaml`
- Build report: `Intermediate/Builds/CHR-GRUNT-001/DESIGN_MASTER/v001/BuildReport.md`

## Source State

- IAS status: `DRAFT`
- Draft override used: `True`
- Dependency files loaded: `10`
...
- `REF_CHR_PLAYER_001_GOLD_MASTER` — `style_only` — `Reference/GoldMasters/CHR-PLAYER-001/Design/CHR-PLAYER-001_DESIGN_MASTER_v001.png`

## Reproducibility Sources

| Repository file | SHA-256 |
|---|---|
| `Intermediate/Builds/CHR-GRUNT-001/DESIGN_MASTER/v001/Build.yaml` | `67c1750d2fbf2203ba5b7863155e32a6204674a46fba6cec60453111f763aa97` |
| `Intermediate/Assets/CHR-GRUNT-001.yaml` | `5dd03cba48d3841902872bab470c761fa6f4137902d78c24a3b775baa219aea2` |
...
| `Core/Naming.yaml` | `64e25b3cd59f232dd89345f1926875dfa7d7bacb9a689884766ef13fa62f6795` |
| `Core/PromptRules.yaml` | `d0ff31f5aa2203996b7bc154ab92ad9683c3a7390c1ff3523bb89bbb5b233cea` |
| `Core/Gameplay.yaml` | `83581625fe8165d928d26c31a807f40b339abaabf25da8fc471c99587ba397d2` |
