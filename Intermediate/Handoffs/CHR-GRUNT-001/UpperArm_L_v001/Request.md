# GAPS External Generation Handoff

Asset: CHR-GRUNT-001
Asset Name: Grunt Soldier 1
Part: UpperArm_L
Stage: parts_manufacturing
Output: Production/CHR-GRUNT-001/03_Parts/UpperArm_L.png

## Task

Generate exactly one production PNG for `UpperArm_L`.
...
`Production/CHR-GRUNT-001/03_Parts/UpperArm_L.png`
