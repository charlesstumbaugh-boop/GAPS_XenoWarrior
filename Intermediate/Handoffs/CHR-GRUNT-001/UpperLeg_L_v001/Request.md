...
Output: Production/CHR-GRUNT-001/03_Parts/UpperLeg_L.png

## Manufacturing Task

Manufacture exactly one production PNG for `UpperLeg_L` from the files contained in
...
`Production/CHR-GRUNT-001/03_Parts/UpperLeg_L.png`
