...
Output: Production/CHR-GRUNT-001/03_Parts/LowerLeg_L.png

## Manufacturing Task

Manufacture exactly one production PNG for `LowerLeg_L` from the files contained in
...
`Production/CHR-GRUNT-001/03_Parts/LowerLeg_L.png`
