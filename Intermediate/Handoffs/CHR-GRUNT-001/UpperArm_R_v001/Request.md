...
Operation: counterpart_generation
Output: Production/CHR-GRUNT-001/03_Parts/UpperArm_R.png

## Manufacturing Task

Manufacture exactly one production PNG for `UpperArm_R` from the files contained in
...
`Production/CHR-GRUNT-001/03_Parts/UpperArm_R.png`
